...
## 2、Query Oceanbase rootservice list
...
## 5、Query rootservice info of all OceanBase clusters in template format
...
## 6、Query idc and region info (empty implementation, just for compatibility)
